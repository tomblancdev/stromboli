                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.TokenRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.JobListResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.JobResponse"
                        }
                    },
                    "404": {
            ...
            "post": {
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_api.AsyncRunResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.SessionListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.SessionDestroyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.SessionMessagesResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.SessionMessageResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid parameters",
        ...
        "internal_api.HealthResponse": {
            ...
            "properties": {
                "components": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.ComponentHealth"
                    }
                },
                "name": {
                    "type": "string",
        ...
        "stromboli_internal_types.PodmanOptions": {
            ...
            "properties": {
                ...
                "lifecycle": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/stromboli_internal_types.LifecycleHooks"
                        }
                    ]
                },
                "memory": {
